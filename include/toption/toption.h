...
TOption *t_option_from_boolean(const gboolean value);
TOption *t_option_from_char(const gchar value);
TOption *t_option_from_uchar(const guchar value);
TOption *t_option_from_string(const gchararray value);
TOption *t_option_from_int(const gint value);
TOption *t_option_from_int64(const gint64 value);
TOption *t_option_from_long(const glong value);
TOption *t_option_from_uint(const guint value);
TOption *t_option_from_uint64(const guint64 value);
TOption *t_option_from_float(const gfloat value);
TOption *t_option_from_double(const gdouble value);
TOption *t_option_from_pointer(const gpointer value);
